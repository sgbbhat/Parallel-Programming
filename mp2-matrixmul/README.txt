EE5940 Machine Problem 2
Matrix Multiplication

1) Untar mp2-matrixmul.tgz into your SDK C/src directory.
...
2) Edit the MatrixMulOnDevice( ... ) function in matrixmul.cu and the
   ...
   Compiling your code will produce the executable mp2-matrixmul in your SDK
...
4) Submit your solution via Moodle as a .tgz file. The file should contain
   the mp2-matrixmul folder provided, with all the changes and additions you
